...
import com.tealer.app.utils.TimeUtils;
...
/**
 * Author：pengbo on 2016/3/26 12:06
 * Email：1162947801@qq.com
 */
public class SocialMainAdapter extends BaseImageListAdapter {
    ...
    public SocialMainAdapter(SocialMainActivity context1,
        ...
        myuserID = HXSDKHelper.getInstance().getCurrentUsernName();
        myNick =HXSDKHelper.getInstance().getUserProfileManager().getCurrentUserInfo().getNick();
        myAvatar = HXSDKHelper.getInstance().getUserProfileManager().getCurrentUserInfo().getAvatar();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (position == 0) {
            ...
            if (holder == null) {
                ...
                holder.image_5 = (ImageView) convertView
                        .findViewById(R.id.image_5);
                holder.image_6 = (ImageView) convertView
                        .findViewById(R.id.image_6);
                holder.image_7 = (ImageView) convertView
                        .findViewById(R.id.image_7);
                holder.image_8 = (ImageView) convertView
                        .findViewById(R.id.image_8);
                holder.image_9 = (ImageView) convertView
            ...
            if (userID.equals(myuserID)) {
                ...
                User user = HXSDKHelper.getInstance().getContactList()
                        .get(userID);
                if (user != null) {
            ...
            holder.tv_time.setText(getTime(rel_time, TimeUtils.getCurrentTime()));
    ...
    private void submitComment(String sID, String comment, TextView tv_comment,
        ...
        map.put("tag", tag);
        SocialApiTaskEngine.getResult(new HttpRequestCallBack(){
            @Override
            ...
            public void onSuccess(String result) {
                ...
                String data= EncodeUtils.removeBOM(result);

             JSONObject json=SocialApiTaskEngine.parseResult(data, context);
                if (data == null) {
                    return;
                }
                int code = 0;
